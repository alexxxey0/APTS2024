...
int get_guard_time(int *guards, int guards_count, int id) {
    for (int i = 0; i <= guards_count; i++) {
        if (guards[i] == id) return guards[i];
    }
    return 0;
}
...
int main() {
    ...
    int p_guards_count, n_guards_count, p_time, n_time, id, time, available_guard;
    ...
    //for (int i = 0; i < p_guards_count; i++) cout << "P " << p_guards[i].id << " " << p_guards[i].time << endl;
    //for (int i = 0; i < n_guards_count; i++) cout << "N " << n_guards[i].id << " " << n_guards[i].time << endl;
